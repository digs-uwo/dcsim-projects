...
public class AppMigRequestEvent extends MessageEvent {
	...
	public AppMigRequestEvent(AutonomicManager target, AppStatus application, AutonomicManager origin, int sender) {
		super(target);
