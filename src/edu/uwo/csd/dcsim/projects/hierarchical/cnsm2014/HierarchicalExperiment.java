...
//		runSimulationSet(printStream, 400, SimTime.hours(40), SimTime.days(10), SimTime.days(2));
		runSimulationSet(printStream, 400, SimTime.hours(40), SimTime.days(10), SimTime.days(0));
	...
	public void setup(Simulation simulation) {
		...
		switch (serviceType) {
			...
			case DYNAMIC:	//Cnsm2014TestEnvironment.configureDynamicServices(simulation, dcManager, legacyLoadGen);
							break;
			case RANDOM:	testEnv.configureRandomServices(simulation, dcManager, baseLoad, additionalLoad, changesPerDay, rampUpTime, startTime, duration);
							break;
		}
	}
