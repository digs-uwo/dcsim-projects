...
public class GrahamDynamicManagement extends DCSimulationTask {
	...
	private static Logger logger = Logger.getLogger(GrahamDynamicManagement.class);
...
//		executor.addTask(new DynamicManagement("dynamic-5", -1519296228623429147l));
	...
	*/
	...
	private static String run(double a, double b, double c, double d){
		...
		SimulationExecutor executor = new SimulationExecutor();
		executor.addTask(new GrahamDynamicManagement("dynamic-1", 3081198553457496232l, a, b, c, d));
		completedTasks = executor.execute();
	...
	public GrahamDynamicManagement(String name, long randomSeed, double a, double b, double c, double d) {
