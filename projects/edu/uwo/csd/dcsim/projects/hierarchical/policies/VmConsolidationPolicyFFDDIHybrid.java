 ...
 * 
 * - relocation candidates: sort VMs in decreasing order by <overall capacity, CPU load>, 
 *   i.e. <memory, cpu cores, core capacity, CPU load>;
 * - target hosts: sort Partially-Utilized and Underutilized hosts in decreasing order 
...
public class VmConsolidationPolicyFFDDIHybrid extends VmConsolidationPolicyLevel0 {
	 ...
	 */
	public VmConsolidationPolicyFFDDIHybrid(AutonomicManager target, double lowerThreshold, double upperThreshold, double targetUtilization) {
