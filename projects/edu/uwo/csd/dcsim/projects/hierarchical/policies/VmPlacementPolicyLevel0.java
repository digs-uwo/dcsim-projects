 ...
 *
 */
public abstract class VmPlacementPolicyLevel0 extends Policy {
	...
	/**
	 * Creates an instance of VmPlacementPolicyLevel0.
	 */
	public VmPlacementPolicyLevel0(AutonomicManager target, double lowerThreshold, double upperThreshold, double targetUtilization) {
