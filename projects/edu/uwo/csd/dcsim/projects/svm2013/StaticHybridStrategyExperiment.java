 ...
 *
 */
public class StaticHybridStrategyExperiment extends SimulationTask {

	private static Logger logger = Logger.getLogger(StaticHybridStrategyExperiment.class);
	
	public StaticHybridStrategyExperiment(String name, long randomSeed) {
	...
	public static void main(String args[]) {
		...
		executor.addTask(new StaticHybridStrategyExperiment("svm2013-static-hybrid-1", 6198910678692541341l));
//		executor.addTask(new HybridStrategyExperiment("svm2013-static-hybrid-2", 5646441053220106016l));
//		executor.addTask(new HybridStrategyExperiment("svm2013-static-hybrid-3", -5705302823151233610l));
//		executor.addTask(new HybridStrategyExperiment("svm2013-static-hybrid-4", 8289672009575825404l));
//		executor.addTask(new HybridStrategyExperiment("svm2013-static-hybrid-5", -4637549055860880177l));
