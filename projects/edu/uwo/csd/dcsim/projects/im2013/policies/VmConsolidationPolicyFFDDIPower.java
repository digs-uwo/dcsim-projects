 ...
 *
 */
public class VmConsolidationPolicyFFDDIPower extends
		VmConsolidationPolicyGreedy {

	/**
	 * Creates a new instance of VmConsolidationPolicyFFDDIPower.
	 */
	public VmConsolidationPolicyFFDDIPower(double lowerThreshold, double upperThreshold, double targetUtilization) {
