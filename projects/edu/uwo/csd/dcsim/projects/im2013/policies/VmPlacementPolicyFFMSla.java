...
/**
 * Implements a First Fit algorithm for the SLA Strategy, where the target 
 * hosts are sorted as follows: Partially-utilized hosts in increasing order 
 * by <CPU utilization, power efficiency>, followed by Underutilized hosts in 
 * decreasing order by <CPU utilization, power efficiency>, and finally Empty 
...
public class VmPlacementPolicyFFMSla extends VmPlacementPolicyGreedy {
	 ...
	 */
	public VmPlacementPolicyFFMSla(double lowerThreshold, double upperThreshold, double targetUtilization) {
