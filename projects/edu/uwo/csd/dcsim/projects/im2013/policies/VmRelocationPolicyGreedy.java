 ...
 *
 */
public abstract class VmRelocationPolicyGreedy extends Policy {
	 ...
	 */
	public VmRelocationPolicyGreedy(double lowerThreshold, double upperThreshold, double targetUtilization) {
