 ...
 * which to run centralized management experiments.
 * 
 * @author Gaston Keller
 *
 */
public class CentralizedTestEnvironment {
...
//	public static final int N_VM_SIZES = 4;
	...
	public static Tuple<DataCentre, AutonomicManager> createDataCentre(Simulation simulation) {
		...
		// Should we install some default management policies in the data centre ???
