 ...
 *
 */
public class VmRelocationPolicyHybridReactive extends VmRelocationPolicyGreedyReactive {

	/**
	 * Creates a new instance of VmRelocationPolicyHybridReactive.
	 */
	public VmRelocationPolicyHybridReactive(double lowerThreshold, double upperThreshold, double targetUtilization) {
